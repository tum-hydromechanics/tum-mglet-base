MODULE particle_io_mod
    ...
    TYPE :: particle_io_t
        ! Allocatable arrays (lists) for all particle attributes
    ...
    CONTAINS
        ...
        PROCEDURE, PUBLIC :: write_particles
        PROCEDURE, PUBLIC :: read_particles
...
CONTAINS
    ...
    SUBROUTINE write_particles(this)
        TYPE(particle_io_t), INTENT(inout) :: this
