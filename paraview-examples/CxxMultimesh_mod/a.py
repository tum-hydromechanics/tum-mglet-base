...
# from paraview.simple.io import SaveData
...
#     assert producer.GetDataInformation().GetNumberOfDataSets() == info2.GetNumberOfDataSets()
    ...
    # producer.relay.io.save(grid)
#     if info.cycle == 1:
# #         SaveData("pythonsave1.yaml", producer)
#         fname = 'RenderView_{info.time:03d}.png'
#         SaveScreenshot(fname,view,ImageResolution=[1000,10000])

png1 = CreateExtractor('PNG',view)
